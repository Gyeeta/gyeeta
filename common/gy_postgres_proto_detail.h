...
using PG_DYN_PREP_MAP			= std::unordered_map<uint32_t, PG_DYN_PREP, GY_JHASHER<uint32_t>>;
...
using PG_DYN_PORTAL_MAP			= std::unordered_map<uint32_t, PG_DYN_PORTAL, GY_JHASHER<uint32_t>>;

struct PG_TRAN_EXTSTAT
{
