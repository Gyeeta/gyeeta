...
static constexpr DB_AGGR_INFO hoststate_aggr_info[] = 
{
	...
	{ "%s(ntasks)::int as ntasks",						FIELD_NPROC,		"ntasks",		"int",		AOPER_AVG,	true, 		0},		
	...
	{ "%s(nlisten)::int as nlisten",					FIELD_NLISTEN,		"nlisten",		"int",		AOPER_AVG,	true, 		0},		
	...
	{ "%s(total_cpu_delay)::bigint as total_cpu_delay",			FIELD_CPUDELMS,		"total_cpu_delay",	"bigint",	AOPER_AVG,	false, 		0},		
	{ "%s(total_vm_delay)::bigint as total_vm_delay",			FIELD_VMDELMS,		"total_vm_delay",	"bigint",	AOPER_AVG,	false, 		0},		
	{ "%s(total_io_delay)::bigint as total_io_delay",			FIELD_IODELMS,		"total_io_delay",	"bigint",	AOPER_AVG,	false, 		0},		
