...
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "machid",								FIELD_PARID,		"machid",		"char(32)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "hostname",								FIELD_HOST,		"hostname",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "madhavaid",								FIELD_MADID,		"madhavaid",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "clustername",							FIELD_CLUSTER,		"clustername",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
};	
...
enum : uint32_t
{
	...
	FIELD_CPUDELMS		= fnv1_consthash("cpudelms"),
	FIELD_VMDELMS		= fnv1_consthash("vmdelms"),
	FIELD_IODELMS		= fnv1_consthash("iodelms"),
};	
...
{ "cpudelms",		"total_cpu_delay", 	GYSLEN("cpudelms"),	FIELD_CPUDELMS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT32,	"int",		DB_STR_NONE,	nullptr, 	nullptr,					"Total CPU Delays in msec",  },
{ "vmdelms",		"total_vm_delay", 	GYSLEN("vmdelms"),	FIELD_VMDELMS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT32,	"int",		DB_STR_NONE,	nullptr, 	nullptr,					"Total Memory Delays in msec",  },
{ "iodelms",		"total_io_delay", 	GYSLEN("iodelms"),	FIELD_IODELMS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT32,	"int",		DB_STR_NONE,	nullptr, 	nullptr,					"Total IO Delays in msec",  },
...
{ "cpudelms",		"total_cpu_delay", 	GYSLEN("cpudelms"),	FIELD_CPUDELMS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT32,	"int",		DB_STR_NONE,	nullptr, 	nullptr,					"Aggregated Total CPU Delays in msec",  },
{ "vmdelms",		"total_vm_delay", 	GYSLEN("vmdelms"),	FIELD_VMDELMS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT64,	"bigint",	DB_STR_NONE,	nullptr, 	nullptr,					"Aggregated Total Memory Delays in msec",  },
{ "iodelms",		"total_io_delay", 	GYSLEN("iodelms"),	FIELD_IODELMS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT64,	"bigint",	DB_STR_NONE,	nullptr, 	nullptr,					"Aggregated Total IO Delays in msec",  },
{ "inrecs",		"inrecs",		GYSLEN("inrecs"),	FIELD_INRECS,		SUBSYS_HOSTSTATE,	JSON_NUMBER,	NUM_INT64,	"bigint",	DB_STR_NONE,	nullptr, 	nullptr,					"Total Detailed Records used for this Aggregation", },
};	

static constexpr DB_AGGR_INFO hoststate_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr,},		
	{ "%s(ntasks_issue)::int as ntasks_issue",				FIELD_NPROCISSUE,	"ntasks_issue",		"int",		AOPER_AVG,	false, 		0,		nullptr,},			
	{ "%s(ntasks_severe)::int as ntasks_severe",				FIELD_NPROCSEVERE,	"ntasks_severe",	"int",		AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(ntasks)::int as ntasks",						FIELD_NPROC,		"ntasks",		"int",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(nlisten_issue)::int as nlisten_issue",				FIELD_NLISTISSUE,	"nlisten_issue",	"int",		AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(nlisten_severe)::int as nlisten_severe",				FIELD_NLISTSEVERE,	"nlisten_severe",	"int",		AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(nlisten)::int as nlisten",					FIELD_NLISTEN,		"nlisten",		"int",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "count(*) filter (where state > 2)::int as issue",			FIELD_ISSUE,		"issue",		"int",		AOPER_COUNT,	false, 		0,		"count(state > 2) as issue",},		
	{ "%s(cpu_issue::int)::int as cpu_issue",				FIELD_CPUISSUE,		"cpu_issue",		"int",		AOPER_SUM,	false, 		0,		nullptr,},		
	{ "%s(mem_issue::int)::int as mem_issue",				FIELD_MEMISSUE,		"mem_issue",		"int",		AOPER_SUM,	false, 		0,		nullptr,},		
	{ "%s(severe_cpu_issue::int)::int as severe_cpu_issue",			FIELD_SEVERECPU,	"severe_cpu_issue",	"int",		AOPER_SUM,	false, 		0,		nullptr,},		
	{ "%s(severe_mem_issue::int)::int as severe_mem_issue",			FIELD_SEVEREMEM,	"severe_mem_issue",	"int",		AOPER_SUM,	false, 		0,		nullptr,},		
	{ "%s(total_cpu_delay)::bigint as total_cpu_delay",			FIELD_CPUDELMS,		"total_cpu_delay",	"bigint",	AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(total_vm_delay)::bigint as total_vm_delay",			FIELD_VMDELMS,		"total_vm_delay",	"bigint",	AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(total_io_delay)::bigint as total_io_delay",			FIELD_IODELMS,		"total_io_delay",	"bigint",	AOPER_AVG,	false, 		0,		nullptr,},		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr,},		
};	
...
static constexpr DB_AGGR_INFO cpumem_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr,},		
	{ "avg(cpu_pct)::real as cpu_pct",					FIELD_CPU_PCT,		"cpu_pct",		"real",		AOPER_AVG,	false, 		0,		"avg(cpu_pct) as cpu_pct",},		
	{ "max(cpu_pct)::real as max_cpu_pct",					FIELD_MAX_CPU_PCT,	"max_cpu_pct",		"real",		AOPER_MAX,	false, 		0,		"max(cpu_pct) as max_cpu_pct",},		
	{ "%s(usercpu_pct)::real as usercpu_pct",				FIELD_USERCPU_PCT,	"usercpu_pct",		"real",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(syscpu_pct)::real as syscpu_pct",					FIELD_SYSCPU_PCT,	"syscpu_pct",		"real",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(iowait_pct)::real as iowait_pct",					FIELD_IOWAIT_PCT,	"iowait_pct",		"real",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(cumul_core_cpu_pct)::real as cumul_core_cpu_pct",			FIELD_CUMUL_CPU_PCT,	"cumul_core_cpu_pct",	"real",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(forks_sec)::int as forks_sec",					FIELD_FORKS_SEC,	"forks_sec",		"int",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(procs_running)::int as procs_running",				FIELD_PROCS,		"procs_running",	"int",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(cs_sec)::bigint as cs_sec",					FIELD_CS_SEC,		"cs_sec",		"bigint",	AOPER_AVG,	true, 		0,		nullptr,},		
	{ "count(*) filter (where cpu_state > 2)::int as cpuissue",		FIELD_CPUISSUE,		"cpuissue",		"int",		AOPER_COUNT,	false, 		0,		"count(cpu_state > 2) as cpuissue",},		
	{ "count(*) filter (where cpu_issue = 1)::int as incpusat",		FIELD_INCPUSAT,		"incpusat",		"int",		AOPER_COUNT,	false, 		0,		"count(cpuissue = 1) as incpusat",},		
	{ "count(*) filter (where cpu_issue = 2)::int as incoresat",		FIELD_INCORESAT,	"incoresat",		"int",		AOPER_COUNT,	false, 		0,		"count(cpuissue = 2) as incoresat",},		
	{ "count(*) filter (where cpu_issue = 3)::int as iniowait",		FIELD_INIOWAIT,		"iniowait",		"int",		AOPER_COUNT,	false, 		0,		"count(cpuissue = 3) as iniowait",},		
	{ "count(*) filter (where cpu_issue = 4)::int as incs",			FIELD_INCS,		"incs",			"int",		AOPER_COUNT,	false, 		0,		"count(cpuissue = 4) as incs",},		
	{ "count(*) filter (where cpu_issue = 5)::int as infork",		FIELD_INFORK,		"infork",		"int",		AOPER_COUNT,	false, 		0,		"count(cpuissue = 5) as infork",},		
	{ "count(*) filter (where cpu_issue = 6)::int as inrproc",		FIELD_INRPROC,		"inrproc",		"int",		AOPER_COUNT,	false, 		0,		"count(cpuissue = 6) as inrproc",},		

	{ "%s(rss_pct)::real as rss_pct",					FIELD_RSS_PCT,		"rss_pct",		"real",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(rss_memory_mb)::bigint as rss_memory_mb",				FIELD_RSS_MB,		"rss_memory_mb",	"bigint",	AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(locked_memory_mb)::bigint as locked_memory_mb",			FIELD_LOCKED_MB,	"locked_memory_mb",	"bigint",	AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(committed_memory_mb)::bigint as committed_memory_mb",		FIELD_COMMIT_MB,	"committed_memory_mb",	"bigint",	AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(committed_pct)::real as committed_pct",				FIELD_COMMIT_PCT,	"committed_pct",	"real",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(swap_free_mb)::bigint as swap_free_mb",				FIELD_SWAP_FREE_MB,	"swap_free_mb",		"bigint",	AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(pg_inout_sec)::int as pg_inout_sec",				FIELD_PG_INOUT_SEC,	"pg_inout_sec",		"int",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(swap_inout_sec)::int as swap_inout_sec",				FIELD_SWAP_INOUT_SEC,	"swap_inout_sec",	"int",		AOPER_AVG,	true, 		0,		nullptr,},		
	{ "%s(reclaim_stalls)::int as reclaim_stalls",				FIELD_RECLAIM_STALLS,	"reclaim_stalls",	"int",		AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(pgmajfault)::int as pgmajfault",					FIELD_PGMAJFAULT,	"pgmajfault",		"int",		AOPER_AVG,	false, 		0,		nullptr,},		
	{ "%s(oom_kill)::int as oom_kill",					FIELD_OOM_KILL,		"oom_kill",		"int",		AOPER_SUM,	false, 		0,		nullptr,},		

	{ "count(*) filter (where mem_state > 2)::int as memissue",		FIELD_MEMISSUE,		"memissue",		"int",		AOPER_COUNT,	false, 		0,		"count(mem_state > 2) as memissue",},		
	{ "count(*) filter (where mem_issue = 1)::int as inrsssat",		FIELD_INRSSSAT,		"inrsssat",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 1) as inrsssat",},		
	{ "count(*) filter (where mem_issue = 2)::int as incmmsat",		FIELD_INCMMSAT,		"incmmsat",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 2) as incmmsat",},		
	{ "count(*) filter (where mem_issue = 3)::int as inpginout",		FIELD_INPGINOUT,	"inpginout",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 3) as inpginout",},		
	{ "count(*) filter (where mem_issue = 4)::int as inswpinout",		FIELD_INSWPINOUT,	"inswpinout",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 4) as inswpinout",},		
	{ "count(*) filter (where mem_issue = 5)::int as inreclaim",		FIELD_INRECLAIM,	"inreclaim",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 5) as inreclaim",},		
	{ "count(*) filter (where mem_issue = 6)::int as inoom",		FIELD_INOOM,		"inoom",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 6) as inoom",},		
	{ "count(*) filter (where mem_issue = 7)::int as inswpspc",		FIELD_INSWPSPC,		"inswpspc",		"int",		AOPER_COUNT,	false, 		0,		"count(memissue = 7) as inswpspc",},		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr,},		
};	
...
static constexpr DB_AGGR_INFO svcstate_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "glob_id",								FIELD_SVCID,		"glob_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "comm",								FIELD_NAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "%s(qps_5s)::int as qps_5s",						FIELD_QPS5S,		"qps_5s",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(nqrys_5s)::int as nqrys_5s",					FIELD_NQRY5S,		"nqrys_5s",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(avg_5s_resp_ms)::int as avg_5s_resp_ms",				FIELD_RESP5S,		"avg_5s_resp_ms",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(p95_5s_resp_ms)::int as p95_5s_resp_ms",				FIELD_P95RESP5S,	"p95_5s_resp_ms",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(p95_5m_resp_ms)::int as p95_5m_resp_ms",				FIELD_P95RESP5M,	"p95_5m_resp_ms",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(nconns)::int as nconns",						FIELD_NCONNS,		"nconns",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(nconns_active)::int as nconns_active",				FIELD_NACTIVE,		"nconns_active",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(ntasks)::int as ntasks",						FIELD_NPROCS,		"ntasks",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(curr_kb_inbound)::bigint as curr_kb_inbound",			FIELD_KBIN15S,		"curr_kb_inbound",	"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(curr_kb_outbound)::bigint as curr_kb_outbound",			FIELD_KBOUT15S,		"curr_kb_outbound",	"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(ser_http_errors)::int as ser_http_errors",			FIELD_SERERR,		"ser_http_errors",	"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(cli_http_errors)::int as cli_http_errors",			FIELD_CLIERR,		"cli_http_errors",	"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(tasks_delay_usec)::bigint as tasks_delay_usec",			FIELD_DELAYUS,		"tasks_delay_usec",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tasks_cpudelay_usec)::bigint as tasks_cpudelay_usec",		FIELD_CPUDELUS,		"tasks_cpudelay_usec",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tasks_blkiodelay_usec)::bigint as tasks_blkiodelay_usec",		FIELD_IODELUS,		"tasks_blkiodelay_usec","bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tasks_vmdelay_usec)::bigint as tasks_vmdelay_usec",		FIELD_VMDELUS,		"tasks_vmdelay_usec",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tasks_user_cpu)::int as tasks_user_cpu",				FIELD_USERCPU,		"tasks_user_cpu",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(tasks_sys_cpu)::int as tasks_sys_cpu",				FIELD_SYSCPU,		"tasks_sys_cpu",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(tasks_rss_mb)::int as tasks_rss_mb",				FIELD_RSSMB,		"tasks_rss_mb",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "count(*) filter (where curr_state > 2)::int as svcissue",		FIELD_SVCISSUE,		"svcissue",		"int",		AOPER_COUNT,	false, 		0,		"count(state > 2) as svcissue", },		
	{ "count(*) filter (where curr_issue = 1)::int as inproc",		FIELD_INPROC,		"inproc",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 1) as inproc", },		
	{ "count(*) filter (where curr_issue = 2)::int as inqps",		FIELD_INQPS,		"inqps",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 2) as inqps", },		
	{ "count(*) filter (where curr_issue = 3)::int as inaconn",		FIELD_INACONN,		"inaconn",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 3) as inaconn", },		
	{ "count(*) filter (where curr_issue = 4)::int as inhttperr",		FIELD_INHTTPERR,	"inhttperr",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 4) as inhttperr", },		
	{ "count(*) filter (where curr_issue = 5)::int as inoscpu",		FIELD_INOSCPU,		"inoscpu",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 5) as inoscpu", },		
	{ "count(*) filter (where curr_issue = 6)::int as inosmem",		FIELD_INOSMEM,		"inosmem",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 6) as inosmem", },		
	{ "count(*) filter (where curr_issue = 7)::int as indepsvc",		FIELD_INDEPSVC,		"indepsvc",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 7) as indepsvc", },		
	{ "count(*) filter (where curr_issue = 8)::int as inunknown",		FIELD_INUNKNOWN,	"inunknown",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 8) as inunknown", },		
	{ "bool_or(is_http_svc) as is_http_svc",				FIELD_ISHTTP,		"is_http_svc",		"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(ishttp) as ishttp", },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
};
...
static constexpr DB_AGGR_INFO svcinfo_aggr_info[] = 
{
	...
	{ "glob_id",								FIELD_SVCID,		"glob_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "comm",								FIELD_NAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "ip",									FIELD_IP,		"ip",			"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "port",								FIELD_PORT,		"port",			"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "related_listen_id",							FIELD_RELSVCID,		"related_listen_id",	"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "starttime",								FIELD_TSTART,		"starttime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "cmdline",								FIELD_CMDLINE,		"cmdline",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "%s(p95resp5d)::int as p95resp5d",					FIELD_P95RESP5D,	"p95resp5d",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(avgresp5d)::int as avgresp5d",					FIELD_AVGRESP5D,	"avgresp5d",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(p95qps)::int as p95qps",						FIELD_P95QPS,		"p95qps",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(p95aconn)::int as p95aconn",					FIELD_P95ACONN,		"p95aconn",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "svcip1",								FIELD_SVCIP1,		"svcip1",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "svcport1",								FIELD_SVCPORT1,		"svcport1",		"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "svcip2",								FIELD_SVCIP2,		"svcip2",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "svcport2",								FIELD_SVCPORT2,		"svcport2",		"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "svcdns",								FIELD_SVCDNS,		"svcdns",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "svctag",								FIELD_SVCTAG,		"svctag",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "public.last_elem(svcmeshid) as svcmeshid",				FIELD_SVCMESHID,	"svcmeshid",		"text",		AOPER_LAST_ELEM,false, 		0,		"last_elem(svcmeshid) as svcmeshid", },			
	{ "%s(nsvcmesh)::int as nsvcmesh",					FIELD_NSVCMESH,		"nsvcmesh",		"int",		AOPER_AVG,	true, 		0,		nullptr, },			
	{ "public.last_elem(ip1cluid) as ip1cluid",				FIELD_IP1CLUID,		"ip1cluid",		"text",		AOPER_LAST_ELEM,false, 		0,		"last_elem(ip1cluid) as ip1cluid", },			
	{ "%s(nip1svc)::int as nip1svc",					FIELD_NIP1SVC,		"nip1svc",		"int",		AOPER_AVG,	true, 		0,		nullptr, },			
	{ "public.last_elem(ip2cluid) as ip2cluid",				FIELD_IP2CLUID,		"ip2cluid",		"text",		AOPER_LAST_ELEM,false, 		0,		"last_elem(ip2cluid) as ip2cluid", },			
	{ "%s(nip2svc)::int as nip2svc",					FIELD_NIP2SVC,		"nip2svc",		"int",		AOPER_AVG,	true, 		0,		nullptr, },			
	{ "region",								FIELD_REGION,		"region",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "zone",								FIELD_ZONE,		"zone",			"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
};
...
static constexpr DB_AGGR_INFO svcsumm_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(nidle)::int as nidle",						FIELD_NIDLE,		"nidle",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ngood)::int as ngood",						FIELD_NGOOD,		"ngood",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nok)::int as nok",						FIELD_NOK,		"nok",			"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nbad)::int as nbad",						FIELD_NBAD,		"nbad",			"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nsevere)::int as nsevere",					FIELD_NSEVERE,		"nsevere",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ndown)::int as ndown",						FIELD_NDOWN,		"ndown",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tot_qps)::int as tot_qps",					FIELD_TOTQPS,		"tot_qps",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(tot_act_conn)::int as tot_act_conn",				FIELD_TOTACONN,		"tot_act_conn",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(tot_kb_inbound)::bigint as tot_kb_inbound",			FIELD_TOTKBIN,		"tot_kb_inbound",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tot_kb_outbound)::bigint as tot_kb_outbound",			FIELD_TOTKBOUT,		"tot_kb_outbound",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tot_ser_errors)::bigint as tot_ser_errors",			FIELD_TOTSERERR,	"tot_ser_errors",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nlisteners)::int as nlisteners",					FIELD_NSVC,		"nlisteners",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(nactive)::int as nactive",					FIELD_NACTIVE,		"nactive",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
};
...
static constexpr DB_AGGR_INFO activeconn_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "listen_id",								FIELD_SVCID,		"listen_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "listen_comm",							FIELD_SVCNAME,		"listen_comm",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cli_aggr_task_id",							FIELD_CPROCID,		"cli_aggr_task_id",	"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cli_comm",								FIELD_CNAME,		"cli_comm",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cli_parthaid",							FIELD_CPARID,		"cli_parthaid",		"char(32)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cli_madhavaid",							FIELD_CMADID,		"cli_madhavaid",	"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(cli_bytes_sent)::bigint as cli_bytes_sent",			FIELD_CNETOUT,		"cli_bytes_sent",	"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(cli_bytes_received)::bigint as cli_bytes_received",		FIELD_CNETIN,		"cli_bytes_received",	"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(cli_delay_msec)::int as cli_delay_msec",				FIELD_CDELMS,		"cli_delay_msec",	"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ser_delay_msec)::int as ser_delay_msec",				FIELD_SDELMS,		"ser_delay_msec",	"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(max_rtt_msec)::real as max_rtt_msec",				FIELD_RTTMS,		"max_rtt_msec",		"real",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(cli_active_conns)::int as cli_active_conns",			FIELD_NCONNS,		"cli_active_conns",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "bool_or(cli_listener_proc) as cli_listener_proc",			FIELD_CSVC,		"cli_listener_proc",	"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(csvc) as csvc", },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
...
static constexpr DB_AGGR_INFO clientconn_aggr_info[] = 
{
	...
	{ "listen_id",								FIELD_SVCID,		"listen_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "listen_comm",							FIELD_SVCNAME,		"listen_comm",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "listen_parthaid",							FIELD_SPARID,		"listen_parthaid",	"char(32)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "listen_madhavaid",							FIELD_SMADID,		"listen_madhavaid",	"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(cli_bytes_sent)::bigint as cli_bytes_sent",			FIELD_CNETOUT,		"cli_bytes_sent",	"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(cli_bytes_received)::bigint as cli_bytes_received",		FIELD_CNETIN,		"cli_bytes_received",	"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(cli_active_conns)::int as cli_active_conns",			FIELD_NCONNS,		"cli_active_conns",	"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "bool_or(cli_listener_proc) as cli_listener_proc",			FIELD_CSVC,		"cli_listener_proc",	"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(csvc) as csvc", },		
...
static constexpr DB_AGGR_INFO procstate_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "aggr_task_id",							FIELD_PROCID,		"aggr_task_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "comm",								FIELD_NAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(tcp_kbytes)::bigint as tcp_kbytes",				FIELD_NETKB,		"tcp_kbytes",		"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(tcp_conns)::int as tcp_conns",					FIELD_NCONN,		"tcp_conns",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(total_cpu_pct)::real as total_cpu_pct",				FIELD_CPU,		"total_cpu_pct",	"real",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(rss_mb)::int as rss_mb",						FIELD_RSS,		"rss_mb",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(cpu_delay_msec)::bigint as cpu_delay_msec",			FIELD_CPUDEL,		"cpu_delay_msec",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(vm_delay_msec)::bigint as vm_delay_msec",				FIELD_VMDEL,		"vm_delay_msec",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(blkio_delay_msec)::bigint as blkio_delay_msec",			FIELD_IODEL,		"blkio_delay_msec",	"bigint",	AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ntasks_total)::int as ntasks_total",				FIELD_NPROCS,		"ntasks_total",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "count(*) filter (where curr_state > 2)::int as issue",		FIELD_ISSUE,		"issue",		"int",		AOPER_COUNT,	false, 		0,		"count(state > 2) as issue", },		
	{ "count(*) filter (where curr_issue = 1)::int as incpudel",		FIELD_INCPUDEL,		"incpudel",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 1) as incpudel", },		
	{ "count(*) filter (where curr_issue = 2)::int as iniodel",		FIELD_INIODEL,		"iniodel",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 2) as iniodel", },		
	{ "count(*) filter (where curr_issue = 3)::int as inswpdel",		FIELD_INSWPDEL,		"inswpdel",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 3) as inswpdel", },		
	{ "count(*) filter (where curr_issue = 4)::int as inrecdel",		FIELD_INRECDEL,		"inrecdel",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 4) as inrecdel", },		
	{ "count(*) filter (where curr_issue = 5)::int as inthrdel",		FIELD_INTHRDEL,		"inthrdel",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 5) as inthrdel", },		
	{ "count(*) filter (where curr_issue = 6)::int as invcsw",		FIELD_INVCSW,		"invcsw",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 6) as invcsw", },		
	{ "count(*) filter (where curr_issue = 7)::int as inivcsw",		FIELD_INIVCSW,		"inivcsw",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 7) as inivcsw", },		
	{ "count(*) filter (where curr_issue = 8)::int as inpgflt",		FIELD_INPGFLT,		"inpgflt",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 8) as inpgflt", },		
	{ "count(*) filter (where curr_issue = 9)::int as incpu",		FIELD_INCPU,		"incpu",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 9) as incpu", },		
	{ "count(*) filter (where curr_issue = 10)::int as instop",		FIELD_INSTOP,		"instop",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 10) as instop", },		
	{ "count(*) filter (where curr_issue = 11)::int as inptr",		FIELD_INPTR,		"inptr",		"int",		AOPER_COUNT,	false, 		0,		"count(issue = 11) as inptr", },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
...
static constexpr DB_AGGR_INFO procinfo_aggr_info[] = 
{
	...
	{ "aggr_task_id",							FIELD_PROCID,		"aggr_task_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "comm",								FIELD_NAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "related_listen_id",							FIELD_RELSVCID,		"related_listen_id",	"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cmdline",								FIELD_CMDLINE,		"cmdline",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "tag",								FIELD_TAG,		"tag",			"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "uid",								FIELD_UID,		"uid",			"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "gid",								FIELD_GID,		"gid",			"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "bool_or(high_cap) as high_cap",					FIELD_HICAP,		"high_cap",		"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(hicap) as hicap", },		
	{ "bool_or(cpu_cg_throttled) as cpu_cg_throttled",			FIELD_CPUTHR,		"cpu_cg_throttled",	"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(cputhr) as cputhr", },		
	{ "bool_or(mem_cg_limited) as mem_cg_limited",				FIELD_MEMLIM,		"mem_cg_limited",	"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(memlim) as memlim", },		
	{ "bool_or(rt_proc) as rt_proc",					FIELD_RTPROC,		"rt_proc",		"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(rtproc) as rtproc", },		
	{ "bool_or(container_proc) as container_proc",				FIELD_CONPROC,		"container_proc",	"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(conproc) as conproc", },		
	{ "tstart",								FIELD_TSTART,		"tstart",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(p95cpupct)::int as p95cpupct",					FIELD_P95CPUPCT,	"p95cpupct",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(p95cpudel)::int as p95cpudel",					FIELD_P95CPUDEL,	"p95cpudel",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(p95iodel)::int as p95iodel",					FIELD_P95IODEL,		"p95iodel",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(nproc)::int as nproc",						FIELD_NPROC,		"nproc",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(nthr)::int as nthr",						FIELD_NTHR,		"nthr",			"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(maxcore)::int as maxcore",					FIELD_MAXCORE,		"maxcore",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(cgcpulimpct)::int as cgcpulimpct",				FIELD_CGCPULIMPCT,	"cgcpulimpct",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "%s(cgrsspct)::int as cgrsspct",					FIELD_CGRSSPCT,		"cgrsspct",		"int",		AOPER_AVG,	true, 		0,		nullptr, },		
	{ "region",								FIELD_REGION,		"region",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "zone",								FIELD_ZONE,		"zone",			"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
...
static constexpr DB_AGGR_INFO hostinfo_aggr_info[] = 
{
	...
	{ "zone",								FIELD_ZONE,		"zone",			"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "machid",								FIELD_PARID,		"machid",		"char(32)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "distribution_name",							FIELD_DIST,		"distribution_name",	"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "kern_version_string",						FIELD_KERNVERSTR,	"kern_version_string",	"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "kern_version_num",							FIELD_KERNVERNUM,	"kern_version_num",	"bigint",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "processor_model",							FIELD_CPUTYPE,		"processor_model",	"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cpu_vendor",								FIELD_CPUVEND,		"cpu_vendor",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(cores_online)::int as cores_online",				FIELD_CORESON,		"cores_online",		"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(cores_offline)::int as cores_offline",				FIELD_CORESOFF,		"cores_offline",	"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(max_cores)::int as max_cores",					FIELD_MAXCORE,		"max_cores",		"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(isolated_cores)::int as isolated_cores",				FIELD_ISOCORE,		"isolated_cores",	"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(ram_mb)::int as ram_mb",						FIELD_RAMMB,		"ram_mb",		"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(num_numa_nodes)::int as num_numa_nodes",				FIELD_NNUMA,		"num_numa_nodes",	"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(threads_per_core)::int as threads_per_core",			FIELD_THRCORE,		"threads_per_core",	"int",		AOPER_SUM,	false, 		0,		nullptr, },		
	{ "boot_time",								FIELD_BOOT,		"boot_time",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "bool_or(is_virtual_cpu) as is_virtual_cpu",				FIELD_VIRT,		"is_virtual_cpu",	"boolean",	AOPER_BOOL_OR,	false, 		0,		"bool_or(virt) as virt", },		
	{ "virtualization_type",						FIELD_VIRTTYPE,		"virtualization_type",	"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "instance_id",							FIELD_INSTANCEID,	"instance_id",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "cloud_type",								FIELD_CLOUDTYPE,	"cloud_type",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
...
static constexpr DB_AGGR_INFO clusterstate_aggr_info[] = 
{
	...
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "clustername",							FIELD_CLUSTER,		"clustername",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(nhosts)::int as nhosts",						FIELD_NHOSTS,		"nhosts",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ntasks_issue)::int as ntasks_issue",				FIELD_NPROCISSUE,	"ntasks_issue",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ntaskissue_hosts)::int as ntaskissue_hosts",			FIELD_NPROCHOSTS,	"ntaskissue_hosts",	"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ntasks)::int as ntasks",						FIELD_NPROC,		"ntasks",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nsvc_issue)::int as nsvc_issue",					FIELD_NLISTISSUE,	"nsvc_issue",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nsvcissue_hosts)::int as nsvcissue_hosts",			FIELD_NLISTHOSTS,	"nsvcissue_hosts",	"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nsvc)::int as nsvc",						FIELD_NLISTEN,		"nsvc",			"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(total_qps)::int as total_qps",					FIELD_TOTQPS,		"total_qps",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(svc_net_mb)::int as svc_net_mb",					FIELD_SVCNETMB,		"svc_net_mb",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(ncpu_issue)::int as ncpu_issue",					FIELD_NCPUISSUE,	"ncpu_issue",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "%s(nmem_issue)::int as nmem_issue",					FIELD_NMEMISSUE,	"nmem_issue",		"int",		AOPER_AVG,	false, 		0,		nullptr, },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
...
{
	// dbexpr											// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr
	{ "",												FIELD_ALERTTIME,	"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },
	{ "count(*)::int as ntotalalt",									FIELD_NTOTALALT,	"ntotalalt",		"int",		AOPER_COUNT,	false, 		0,		"count(*) as ntotalalt", },
	{ "count(*) filter (where tclose is null)::int as nopenalt",					FIELD_NOPENALT,		"nopenalt",		"int",		AOPER_COUNT,	false, 		0,		"count(tclose is null) as nopenalt", },
	{ "count(*) filter (where astate = 'acked')::int as nackalt",					FIELD_NACKALT,		"nackalt",		"int",		AOPER_COUNT,	false, 		0,		"count(astate = 'acked') as nackalt", },
	{ "count(*) filter (where astate = 'resolved')::int as nresolvedalt",				FIELD_NRESOLVEDALT,	"nresolvedalt",		"int",		AOPER_COUNT,	false, 		0,		"count(astate = 'resolved') as nresolvedalt", },
	{ "count(*) filter (where astate = 'expired')::int as nexpiredalt",				FIELD_NEXPIREDALT,	"nexpiredalt",		"int",		AOPER_COUNT,	false, 		0,		"count(astate = 'expired') as nexpiredalt", },
	{ "count(*) filter (where severity = 'critical')::int as totalcrit",				FIELD_TOTALCRIT,	"totalcrit",		"int",		AOPER_COUNT,	false, 		0,		"count(severity = 'critical') as totalcrit", },
	{ "count(*) filter (where severity = 'critical' and tclose is null)::int as opencrit",		FIELD_OPENCRIT,		"opencrit",		"int",		AOPER_COUNT,	false, 		0,		"count(severity = 'critical' and tclose is null) as opencrit", },
	{ "count(*) filter (where severity = 'warning')::int as totalwarn",				FIELD_TOTALWARN,	"totalwarn",		"int",		AOPER_COUNT,	false, 		0,		"count(severity = 'warning') as totalwarn", },
	{ "count(*) filter (where severity = 'warning' and tclose is null)::int as openwarn",		FIELD_OPENWARN,		"openwarn",		"int",		AOPER_COUNT,	false, 		0,		"count(severity = 'warning' and tclose is null) as openwarn", },
	{ "max(tclose - time)::interval as maxtresolve",						FIELD_MAXTRESOLVE,	"maxtresolve",		"interval",	AOPER_MAX,	false, 		0,		"max(tclose - alerttime) as maxtresolve", },
	{ "date_trunc('sec', avg(tclose - time)::interval) as meantresolve",				FIELD_MEANTRESOLVE,	"meantresolve",		"interval",	AOPER_AVG,	false, 		0,		nullptr, },
	{ "count(*)::int as inrecs",									FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
};	
...
enum : uint32_t
{
	...
	FIELD_SPORT		= fnv1_consthash("sport"),
...
static constexpr DB_AGGR_INFO tracereq_aggr_info[] = 
{
	...
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "glob_id",								FIELD_SVCID,		"glob_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "comm",								FIELD_SVCNAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "serport",								FIELD_SPORT,		"serport",		"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "appname",								FIELD_APP,		"appname",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "username",								FIELD_USER,		"username",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "dbname",								FIELD_DB,		"dbname",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "cliip",								FIELD_CIP,		"cliip",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "avg(response)::bigint as avgrespus",					FIELD_AVGRESPUS,	"avgrespus",		"bigint",	AOPER_AVG,	true, 		0,		"avg(respus) as avgrespus", },		
	{ "max(response)::bigint as maxrespus",					FIELD_MAXRESPUS,	"maxrespus",		"bigint",	AOPER_MAX,	true, 		0,		"max(respus) as maxrespus", },		
	{ "public.tdigest_percentile(response, 100, 0.99)::bigint as p99respus",
										FIELD_P99RESPUS,	"p99respus",		"bigint",	AOPER_PERCENTILE,true, 		0,		"percentile(0.99, respus) as p99respus", },		
	{ "count(*)::bigint as nreq",						FIELD_NREQ,		"nreq",			"bigint",	AOPER_COUNT,	false, 		0,		"count(*) as nreq", },		
	{ "count(*) filter (where errorcode != 0)::bigint as nerr",		FIELD_NERR,		"nerr",			"bigint",	AOPER_COUNT,	false, 		0,		"count(err != 0) as nerr", },		
	{ "sum(bytesin)::bigint as bytesin",					FIELD_SUMNETIN,		"bytesin",		"bigint",	AOPER_SUM,	false, 		0,		"sum(netin) as sumnetin", },		
	{ "sum(bytesout)::bigint as bytesout",					FIELD_SUMNETOUT,	"bytesout",		"bigint",	AOPER_SUM,	false, 		0,		"sum(netout) as sumnetout", },		
	{ "max(bytesin)::bigint as maxbytesin",					FIELD_MAXNETIN,		"maxbytesin",		"bigint",	AOPER_MAX,	false, 		0,		"max(netin) as maxnetin", },		
	{ "max(bytesout)::bigint as maxbytesout",				FIELD_MAXNETOUT,	"maxbytesout",		"bigint",	AOPER_MAX,	false, 		0,		"max(netout) as maxnetout", },		
	{ "count(*) filter (where reqnum = 0)::bigint as nconns",		FIELD_NCONNS,		"nconns",		"bigint",	AOPER_COUNT,	false, 		0,		"count(nreq = 0) as nconns", },		
	{ "public.last_elem(proto)::char(16) as proto",				FIELD_PROTO,		"proto",		"char(16)",	AOPER_LAST_ELEM,false, 		0,		"last_elem(proto) as proto", },			
	{ "count(*) filter (where response < 300)::bigint as resplt300us",	FIELD_RESPLT300US,	"resplt300us",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus < 300) as resplt300us", },		
	{ "count(*) filter (where response >= 300 and response < 1000)::bigint as resplt1ms",		
										FIELD_RESPLT1MS,	"resplt1ms",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 300 and respus < 1000) as resplt1ms", },		
	{ "count(*) filter (where response >= 1000 and response < 10000)::bigint as resplt10ms",		
										FIELD_RESPLT10MS,	"resplt10ms",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 1000 and respus < 10000) as resplt10ms", },		
	{ "count(*) filter (where response >= 10000 and response < 30000)::bigint as resplt30ms",		
										FIELD_RESPLT30MS,	"resplt30ms",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 10000 and respus < 30000) as resplt30ms", },		
	{ "count(*) filter (where response >= 30000 and response < 100000)::bigint as resplt100ms",		
										FIELD_RESPLT100MS,	"resplt100ms",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 30000 and respus < 100000) as resplt100ms", },		
	{ "count(*) filter (where response >= 100000 and response < 300000)::bigint as resplt300ms",		
										FIELD_RESPLT300MS,	"resplt300ms",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 100000 and respus < 300000) as resplt300ms", },		
	{ "count(*) filter (where response >= 300000 and response < 1000000)::bigint as resplt1sec",		
										FIELD_RESPLT1SEC,	"resplt1sec",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 300000 and respus < 1000000) as resplt1sec", },		
	{ "count(*) filter (where response >= 1000000)::bigint as respgt1sec",	
										FIELD_RESPGT1SEC,	"respgt1sec",		"bigint",	AOPER_COUNT,	false, 		0,		"count(respus >= 1000000) as respgt1sec", },		
	{ "count(*)::bigint as inrecs",						FIELD_INRECS,		"inrecs",		"bigint",	AOPER_COUNT,	false, 		0,		nullptr, },		
};
...
static constexpr DB_AGGR_INFO traceuniq_aggr_info[] = 
{
	// dbexpr								// jsoncrc		// dbfieldname		// dbfieldtype	// dflt_aggr	// ignore_sum	// extarg	// qryexpr	
	{ "",									FIELD_TIME,		"atime",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "uniqreq",								FIELD_UNIQREQ,		"uniqreq",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "%s(ncnt)::bigint as ncnt",						FIELD_NCNT,		"ncnt",			"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(avgresp)::bigint as resp",					FIELD_RESPUS,		"resp",			"bigint",	AOPER_AVG,	true, 		0,		nullptr, },		
	{ "max(maxresp)::bigint as maxresp",					FIELD_MAXRESPUS,	"maxresp",		"bigint",	AOPER_MAX,	true, 		0,		"max(maxrespus) as maxresp", },		
	{ "%s(avgbytesin * ncnt)::bigint as bytesin",				FIELD_NETIN,		"bytesin",		"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(avgbytesout * ncnt)::bigint as bytesout",				FIELD_NETOUT,		"bytesout",		"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "%s(nerror)::bigint as nerror",					FIELD_NERR,		"nerror",		"bigint",	AOPER_SUM,	false, 		0,		nullptr, },		
	{ "glob_id",								FIELD_SVCID,		"glob_id",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "comm",								FIELD_NAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "proto",								FIELD_PROTO,		"proto",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "uniqid",								FIELD_UNIQID,		"uniqid",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "count(*)::int as inrecs",						FIELD_INRECS,		"inrecs",		"int",		AOPER_COUNT,	false, 		0,		nullptr, },		
};	
...
static constexpr DB_AGGR_INFO tracestatus_aggr_info[] = 
{
	...
	{ "comm",								FIELD_NAME,		"comm",			"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "port",								FIELD_PORT,		"port",			"int",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "public.last_elem(tlast) as tlast",					FIELD_TLAST,		"tlast",		"timestamptz",	AOPER_LAST_ELEM,false, 		0,		"last_elem(tlast) as tlast", },	
	{ "public.last_elem(state) as state",					FIELD_STATE,		"state",		"char(16)",	AOPER_LAST_ELEM,false, 		0,		"last_elem(state) as state", },			
	{ "public.last_elem(proto) as proto",					FIELD_PROTO,		"proto",		"char(16)",	AOPER_LAST_ELEM,false, 		0,		"last_elem(proto) as proto", },			
	{ "public.last_elem(istls) as istls",					FIELD_ISTLS,		"istls",		"boolean",	AOPER_LAST_ELEM,false, 		0,		"last_elem(istls) as istls", },			
	{ "tstart",								FIELD_TSTART,		"tstart",		"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "tend",								FIELD_TEND,		"tend",			"timestamptz",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "public.last_elem(nreq) as nreq",					FIELD_NREQ,		"nreq",			"bigint",	AOPER_LAST_ELEM,true, 		0,		"last_elem(nreq) as nreq", },	
	{ "public.last_elem(nerr) as nerr",					FIELD_NERR,		"nerr",			"bigint",	AOPER_LAST_ELEM,true, 		0,		"last_elem(nerr) as nerr", },	
	{ "defid",								FIELD_DEFID,		"defid",		"char(8)",	AOPER_GROUPBY,	false, 		0,		nullptr, },			
	{ "machid",								FIELD_PARID,		"machid",		"char(32)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "hostname",								FIELD_HOST,		"hostname",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "madhavaid",								FIELD_MADID,		"madhavaid",		"char(16)",	AOPER_GROUPBY,	false, 		0,		nullptr, },		
	{ "clustername",							FIELD_CLUSTER,		"clustername",		"text",		AOPER_GROUPBY,	false, 		0,		nullptr, },			
